...
pub fn spl_token_transfer(params: TokenTransferParams<'_, '_>) -> ProgramResult {
    ...
    result.map_err(|_| MonkError::TokenTransferFailed.into())
}
...
pub fn spl_token_set_authority(params : TokenSetAuthorityParams<'_>) -> ProgramResult {
    ...
    result.map_err(|_| MonkError::TokenSetAuthorityFailed.into())
}
...
pub fn spl_token_mint_to(params : TokenMintToParams<'_>) -> ProgramResult {
    ...
    result.map_err(|_| MonkError::TokenMintToFailed.into())
}
